---
title: "TailwindCSS Template | UIdeck Docs"
description: TailwindCSS Template Docs.
---

## Introduction

We use plain HTML and TailwindCSS to create static templates, and few vanilla JS plugins for interaction (like slider, video and image popup).
...
If you want to edit just go with `src` folder here you will get all files.
